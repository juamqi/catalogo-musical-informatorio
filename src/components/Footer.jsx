export default function Footer() {
  return (
    <footer className="w-full bg-[#1E3E62]/50 backdrop-blur-md shadow-lg fixed bottom-0 left-0 text-center py-4 z-50">
      <div className="container mx-auto px-6 flex flex-col sm:flex-row justify-between items-center gap-4 text-sm text-white">
        ...
        <div className="flex gap-5">
          <a href="https://github.com/juamqi/catalogo-musical-informatorio" target="_blank" rel="noopener noreferrer" className="hover:text-[#FF6500] transition-colors text-white">
          ...
          <a href="https://www.linkedin.com/in/juamqi" target="_blank" rel="noopener noreferrer" className="hover:text-[#FF6500] transition-colors text-white">
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" className="w-5 h-5">
