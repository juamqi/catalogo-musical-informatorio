export default function Footer() {
  return (
    <footer className="w-full h-12 bg-black fixed bottom-0 left-0 text-center z-50 flex items-center border-t border-white/50">
      <div className="container mx-auto px-6 h-full flex flex-col sm:flex-row justify-between items-center gap-4 text-sm text-white">
        <p className="text-center sm:text-left">
          Desarrollado por <span className="font-bold">Juan Pablo Kass</span> para la Etapa 3 del Informatorio: Especialización en React.js
        </p>
        <div className="flex gap-5">
          <a href="https://github.com/juamqi/catalogo-musical-informatorio" target="_blank" rel="noopener noreferrer" className="hover:text-[#EDF252] transition-colors text-white">
          ...
          <a href="https://www.linkedin.com/in/juamqi" target="_blank" rel="noopener noreferrer" className="hover:text-[#EDF252] transition-colors text-white">
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" className="w-5 h-5">
